/**
 * Master Test Suite Runner for MindGuard AI Capstone
 * Zero dependencies — runs natively on any Node.js 18+ runtime.
 */
...
console.log('\n======================================================');
console.log(' MindGuard AI · Capstone Automated Verification Suite ');
console.log('======================================================\n');
