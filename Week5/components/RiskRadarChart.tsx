...
export const RiskRadarChart: React.FC<RiskRadarChartProps> = ({ scores, size = 220 }) => {
  ...
  // 4 Axes: North (Affective), East (Cognitive), South (Somatic), West (Crisis)
  const axes = [
  ...
  // Concentric guideline rings at 25%, 50%, 75%, 100%
  ...
  return (
    <div className="flex flex-col items-center justify-center p-2">
      ...
      >
        ...
        {/* Vertex points with pulse rings */}
        {axes.map((axis, i) => {
          const normalized = Math.min(100, Math.max(0, axis.value)) / 100;
          const r = normalized * radius;
      ...
      {/* Horizontal Bar Breakdown for Accessibility & Quick Scan */}
