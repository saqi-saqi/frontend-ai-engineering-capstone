...
import { TriageAssessmentResult } from '../types';
...
export const TriageScoreCard: React.FC<TriageScoreCardProps> = ({
  ...
  return (
    ...
    >
      ...
      {/* Body: Risk Radar Visualization & Symptom Pills */}
