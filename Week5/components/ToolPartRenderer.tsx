...
import { Terminal, Cpu, Loader2, Sparkles, Activity } from 'lucide-react';
import { TOOL_NAMES, executeEmergencyEscalation } from '../tools/triage-tool';
...
export const ToolPartRenderer: React.FC<ToolPartRendererProps> = ({
  ...
  // What is it doing? Model is dynamically streaming JSON tool call arguments.
  // ==========================================================================
  ...
  // With what input? Parameters received; tool actively executing on server.
  // ==========================================================================
  ...
  // What went wrong? Designed error state with retry callback (not a crash).
  // ==========================================================================
  ...
  // What came back? Rendered as a real Generative UI Component with 200ms morph.
  // ==========================================================================
  if (state === 'output-available') {
    // Branch based on tool type:
    ...
    // Generic fallback if unknown tool output
    return (
