# Phase: Build (Core) — Workflows, Agents, and the Model Context Protocol (MCP)
...
**Estimated Time**: 5 Hours | **Status**: Completed
...
* **Objective**: Read the exact live contents of `Week5/NO_CODE_WORKFLOW_PIPELINE.md` directly from the local Windows filesystem to audit line counts and verify artifact generation.
...
```json
{
  ...
  "params": {
    "name": "read_file",
    "arguments": {
      "path": "c:/Users/user/Desktop/Front_end_Ai_engineering/Week5/NO_CODE_WORKFLOW_PIPELINE.md"
    }
  }
}
```
...
> *"I have accessed your local filesystem via the MCP `read_file` tool. The file `NO_CODE_WORKFLOW_PIPELINE.md` physically exists on your Windows disk at `c:/Users/user/Desktop/Front_end_Ai_engineering/Week5/`, containing exactly 458 lines and 40,367 bytes. It contains the complete five-run empirical synthesis for MindGuard AI."*
...
1. **Markdown Explainer & Evidence**:  
   [`Week5/WORKFLOW_VS_AGENT_MCP.md`](file:///c:/Users/user/Desktop/Front_end_Ai_engineering/Week5/WORKFLOW_VS_AGENT_MCP.md)
2. **Interactive Styled Webpage (with visual MCP inspector)**:  
   [`Week5/WORKFLOW_VS_AGENT_MCP.html`](file:///c:/Users/user/Desktop/Front_end_Ai_engineering/Week5/WORKFLOW_VS_AGENT_MCP.html)
